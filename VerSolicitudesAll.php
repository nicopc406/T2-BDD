    ...
    <div class="container">
        <div class="table-container">
            ...
            <?php if ($tipo_solicitud === 'Funcionalidad'): ?>
                <?php
                $sql = "SELECT titulo, ambiente, resumen, topico, solicitante, estado FROM Vista_Solicitudes WHERE tipo = 'Funcionalidad' ORDER BY fecha DESC";
            ...
            <?php elseif ($tipo_solicitud === 'Error'): ?>
                <?php
                $sql = "SELECT titulo, descripcion, fecha, topico, solicitante, estado FROM Vista_Solicitudes WHERE tipo = 'Error' ORDER BY fecha DESC";
                $resultado = $conexion->query($sql);
                ?>
                <table>
                    <thead>
