...
-- ---------------------------------
-- COMPONENTES SQL ADICIONALES
-- ---------------------------------

--
-- 1. VISTA (VIEW)
--
-- Propósito: Una vista para simplificar la consulta de solicitudes de funcionalidad (requisito de la página principal para ingenieros).
--
